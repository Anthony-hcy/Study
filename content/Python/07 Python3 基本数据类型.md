...
my\_str = 'Runoob' # 定义一个字符串变量（避免使用 str 作为变量名，会覆盖内置类型）  
  
print(my\_str) # 打印整个字符串：Runoob  
print(my\_str\[0:-1\]) # 打印索引 0 到倒数第二个字符（不含最后一个）：Runoo  
print(my\_str\[0\]) # 打印第一个字符：R  
print(my\_str\[2:5\]) # 打印索引 2、3、4 的字符（不含索引 5）：noo  
print(my\_str\[2:\]) # 打印从索引 2 开始到末尾：noob  
print(my\_str \* 2) # 重复打印两次：RunoobRunoob  
print(my\_str + "TEST") # 字符串拼接：RunoobTEST
