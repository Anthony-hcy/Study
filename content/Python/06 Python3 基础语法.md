...
def is\_valid\_identifier(name):  
try:  
exec(f"{name} = None")  
return True  
except:  
...
print(is\_valid\_identifier("2var")) # False  
print(is\_valid\_identifier("var2")) # True
...
''' 第三注释 第四注释 ''' """ 第五注释 第六注释 """ print ("Hello, Python!")
...
str='123456789' print(str) print(str\[0:-1\]) print(str\[0\]) print(str\[2:5\]) print(str\[2:\]) print(str\[1:5:2\]) print(str \* 2) print(str + '你好') print('------------------------------') print('hello\\nrunoob') print(r'hello\\nrunoob')
...
x="a" y="b" print( x ) print( y ) print('---------') print( x, end=" " ) print( y, end=" " ) print()
...
from sys import argv,path print('================python from import===================================') print('path:',path)
